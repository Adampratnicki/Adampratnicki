document.addEventListener('DOMContentLoaded', function() {
    ...
    case "onas":
    clearInput();
    addTextToResults("AJ.CORP, kooperacja dwóch GEJMERÓW ( RANGI W CS DMG / LEM )");
    break;
    case "cd":
    clearInput();
    ...
    default:
    clearInput();
    addTextToResults("<p><i>Komendy " + "<b>" + textInputValue + "</b>" + " Nie znalazłem :/. Wpisz <b>Help/Pomoc</b>Aby zobaczyć podstwawowe komendy.</i></p>");
    break;
    }
    }
    ...
    } else if (textInputValueLowerCase.substr(0,5) == "index"){
    openLinkInNewWindow('../index.html' + textInputValueLowerCase.substr(5));
    addTextToResults("<i>Zapraszam na strone główną " + "<b>" + textInputValue.substr(5) + "</b>" + " strona powinna się otworzyć w twojej przeglądarce.</i>");    
    }else if (textInputValueLowerCase.substr(0,5) == "ubuntu"){
    openLinkInNewWindow('../linx/ubuntu.html' + textInputValueLowerCase.substr(5));
    addTextToResults("<i>Zapraszam na strone główną " + "<b>" + textInputValue.substr(5) + "</b>" + " strona powinna się otworzyć w twojej przeglądarce.</i>");    
    }else if (textInputValueLowerCase.substr(0,5) == "mint"){
    openLinkInNewWindow('../linx/mint.html' + textInputValueLowerCase.substr(5));
    addTextToResults("<i>Zapraszam na strone główną " + "<b>" + textInputValue.substr(5) + "</b>" + " strona powinna się otworzyć w twojej przeglądarce.</i>");    
    }else if (textInputValueLowerCase.substr(0,5) == "kali"){
    openLinkInNewWindow('../linx/kali.html' + textInputValueLowerCase.substr(5));
    addTextToResults("<i>Zapraszam na strone główną " + "<b>" + textInputValue.substr(5) + "</b>" + " strona powinna się otworzyć w twojej przeglądarce.</i>");    
    }
     else{
    textReplies();
